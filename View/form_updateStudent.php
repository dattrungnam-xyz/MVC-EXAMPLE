...
<body>
    ...
    <div style="display:flex; ">
        ...
        <div class="container">
            ...
            echo '
    <form onsubmit="return handleSubmit()" name="f1" style="width: 400px;" action="C_Student.php?mod3=1&Id=' . $student->id . '" method="post">
        <div style="display: flex; justify-content: space-between; margin-bottom:4px;">
            <label for="Id">ID</label>
            <input readonly type="text" value="'. $student->id .'"  name="Id" id="Id">
        </div>
        <div style="display: flex; justify-content: space-between; margin-bottom:4px;">
            <label for="Name">Name</label>
            <input onchange="handleChange()" value="' . $student->name . '" type="text" name="Name"      id="Name">
        </div>
        <div style="display: flex; justify-content: space-between; margin-bottom:4px;">
            <label for="Age">Age</label>
            <input onchange="handleChange()" type="text" name="Age"   value="' . $student->age . '"   id="Age">
        </div>
        <div style="display: flex; justify-content: space-between; margin-bottom:4px;">
            <label for="University">University</label>
            <input onchange="handleChange()" type="text"  value="' . $student->university . '" name="University" id="University">
        </div>
        <p class="p_text"></p>
